...
const LogInstructions = (props) => {
    return(
        <div className={LogInstructionsStyle.instructionsContainer}>
            ...
            <h3 className={LogInstructionsStyle.instructions}>Please enter your credentials to log in. If you do not have an account, please use the <span><Link to = "/home">Sign Up</Link></span> button</h3>
        </div>
    );
};
